...
INSERT INTO payments (payment_date, student_id, payment_method, amount, currency, created_at, updated_at) VALUES
(CURRENT_DATE(), 1, 'CARD', 100.00, 'EUR', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()), -- John Doe
(CURRENT_DATE(), 2, 'CASH', 150.00, 'EUR', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()), -- Jane Smith
(CURRENT_DATE(), 3, 'CARD', 40.00, 'EUR', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),  -- Carlos Ruiz
(CURRENT_DATE(), 4, 'PAYPAL', 30.00, 'EUR', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());   -- Hanna Petrenko
