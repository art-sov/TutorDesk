INSERT INTO students (first_name, last_name, knowledge_level, country, phone_number, global_goal, age, price, currency) VALUES
('John', 'Doe', 'B2', 'USA', '+1-202-555-0177', 'Pass the TOEFL exam for university admission', 22, 25.00, 'USD'),
('Jane', 'Smith', 'C1', 'UK', '+44-20-7946-0958', 'Improve business English for career advancement', 29, 30.00, 'PLN'),
('Carlos', 'Ruiz', 'A2', 'Spain', '+34-91-555-0123', 'Learn basic conversation skills for upcoming travel', 35, 20.00, 'EUR'),
('Hanna', 'Petrenko', 'B1', 'Ukraine', '+7-495-555-0182', 'Be able to communicate with foreign colleagues', 26, 22.00, 'EUR'),
('Mohammed', 'Ali', 'C2', 'Egypt', '+20-2-555-0145', 'Achieve near-native fluency for a translation job', 31, 28.00, 'USD');
